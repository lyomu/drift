...
/// League Rules — `foundation/04-screen-inventory.md` §A.5. Plain rules
/// text; nothing in the foundation docs specifies a structured rules
/// schema, so this stays a simple text screen.
      ...
      body: SafeArea(
        child: RefreshIndicator(
          ...
          child: switch (league) {
            ...
            AsyncError() => const Center(child: Text('Rules not available.')),
