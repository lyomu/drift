/**
 * ISO 3166-1 style country and territory options for the waitlist country
 * selector. Kept separate from landing copy so the global list stays easy to
 * replace if the source list changes.
 */
