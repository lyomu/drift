...
export class ClubOperationsController {
  ...
  moderation(
    @Param('clubId') clubId: string,
    @Query('status') status?: ClubPostModerationStatus,
  ) {
  ...
  resolveModeration(
    ...
    @Param('clubId') clubId: string,
    @Param('id') id: string,
    @Body('status') status: ClubPostModerationStatus,
  ) {
    return this.operations.resolveModeration(
      clubId,
      id,
      this.userId(req),
      status,
  ...
  updateNotificationSettings(
    ...
    return this.operations.updateNotificationSettings(
      clubId,
      this.userId(req),
      body,
    );
