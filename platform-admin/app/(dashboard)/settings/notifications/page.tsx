...
export default function NotificationTemplatesPage() {
  ...
  return (
    <div>
      <SectionHeader title="Notification Templates" description="Push, email, and SMS copy with a draft/live lifecycle. Only live templates are sent." action={<Button variant="secondary" icon="add" onClick={startNew}>New template</Button>} />
      <ErrorBanner message={error} />

      <StatBand
        stats={[
          { label: "Live", value: counts.live, icon: "send", tone: "green" },
          { label: "Draft", value: counts.draft, icon: "edit_note", tone: "gray" },
        ]}
      />
